...
| Questions, chit-chat and tool noise get stored as "facts". | A deterministic evaluator rejects interrogatives, filler and system payloads before they reach storage. Hook adapters cap and filter what they observe. |
